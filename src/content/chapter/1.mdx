...
<WordTable headings={["Word", "Pronounciation", "Meaning"]} columns={[1, 0]}>
    <WordReveal word="АЭРОПОРТ" />
    <WordReveal word="БУФЕТ" />
    <WordReveal word="ГОСТИНИЦА" />
    <WordReveal word="ДИРЕКТОР" />
    <WordReveal word="ЗАКРЫТО" />
    <WordReveal word="ЗАПРЕНЩЕНО" />
    <WordReveal word="ИНТУРИСТ" />
    <WordReveal word="КАССА" />
    <WordReveal word="К СЕБЕ" />
    <WordReveal word="НЕ КУРИТЬ" />
    <WordReveal word="ОТ СЕБЯ" />
    <WordReveal word="ПАРИКМАХЕРСКАЯ" />
    <WordReveal word="ПОЧТА" />
    <WordReveal word="РЕМОНТ" />
    <WordReveal word="РЕСТОРАН" />
    <WordReveal word="ТУАЛЕТ" />
</WordTable>
...
<WordTable headings={["Word", "Pronounciation", "Meaning"]} columns={[1, 0]}>
    <WordReveal word="БАР" />
    <WordReveal word="ПРАВДА" />
    <WordReveal word="ТАКСИ" />
    <WordReveal word="СТОП" />
    <WordReveal word="МОСКВА" />
    <WordReveal word="ЛОС АНДЖЕЛЕС" />
    <WordReveal word="ПИЦЦА ХАТ" />
    <WordReveal word="ВЛАДИМИР ЛЕНИН" />
    <WordReveal word="ИЗВЕСТИЯ" />
    <WordReveal word="НЬЮ-ЙОРК" />
    <WordReveal word="ГЛАСНОСТЬ" />
    <WordReveal word="РОЛЛС-РОЙС" />
    <WordReveal word="БИТЛЗ" />
    <WordReveal word="ШЕКСПИР" />
    <WordReveal word="ХЕЛЬСИНКИ" />
</WordTable>
