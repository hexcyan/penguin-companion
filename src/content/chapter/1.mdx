...
export const map1 = {
    ...
    tr: {
        ...
        hover: "For comparison, in the phonetic *transcription* used i this book, this name would be **[na-tál<sup>y</sup>a>**"
    }
...
NOTE: In Russian italic printing, **г** is _г_, **д** is _д_, **и** is _и_, **й** is _й_, **л** is _л_, **п** is _п_, **т** is _т_. You will see in [Lesson 2](/chapter/2)
...
{/* fix inline hover */}
Example of <WordHover word={map1["tr"].word} hoverText={map1["tr"].hover} /> (a woman’s name):
